<template>
  <div class="page-debug" @click="goNext($event)">
    <div>
      Debug 调试页面bb
      <dwd-badge text="New" class="fr" position="top-right">
    ...
    <div class="list">
      ...
      <div class="content">
        <label
          class="btn"
        ><input v-model="apiEnv" type="radio" data-type="env" value="prod">Prod</label>
        <label
          class="btn"
        ><input v-model="apiEnv" type="radio" data-type="env" value="beta">Beta</label>
        <label
          class="btn"
        ><input v-model="apiEnv" type="radio" data-type="env" value="dev">Dev</label>
